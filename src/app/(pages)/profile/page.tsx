    ...
    <>
      ...
      <div className="min-h-[80vh] bg-slate-50 flex items-center justify-center p-4 font-sans">
        <div className="w-full max-w-lg bg-white rounded-4xl shadow-2xl overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-3xl">
          <div className="h-40 bg-linear-to-r from-blue-600 via-blue-500 to-indigo-600 relative"></div>
          ...
          <div className="px-8 pb-10">
            ...
            <div className="text-center space-y-3">
              ...
              <div className="flex gap-4 justify-center">
                ...
                <button
                  className="px-8 py-3.5 border cursor-pointer border-slate-200 text-slate-700 rounded-2xl font-medium text-base hover:bg-slate-50 hover:border-slate-300 transition-all"
                  onClick={() => signOut()}
                >
                  Sign Out
                </button>
